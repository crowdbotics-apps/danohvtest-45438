"""
Django settings for danohvtest_45438 project.
...
ROOT_URLCONF = 'danohvtest_45438.urls'
...
WSGI_APPLICATION = 'danohvtest_45438.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "danohvtest_45438 API",
    "DESCRIPTION": "API documentation for danohvtest_45438 App",
    "VERSION": "v1",
}
